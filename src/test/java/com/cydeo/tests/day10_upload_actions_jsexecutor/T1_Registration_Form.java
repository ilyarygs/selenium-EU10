...
public class T1_Registration_Form {
    ...
    @Test
    public void registration_from_test(){
        ...
        WebElement inputPhone = Driver.getDriver().findElement(By.xpath("//input[@name='phone']"));  //  "//input[@name='']"
        ...
        inputBirthday.sendKeys("05/09/1998");
